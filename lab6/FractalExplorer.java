...
public class FractalExplorer
{
    ...
    /** Integer count of rows SwingWorker has left to do. **/
    ...
    private class FractalWorker extends SwingWorker<Object, Object>
    {
        ...
        /**
         * Called after background task is done
         */
        protected void done() {
            for (int i = 0; i < computedRGBValues.length; i++) {
             ...
             /**
              * When the row have been drawn, repaint JImageDisplay to match
