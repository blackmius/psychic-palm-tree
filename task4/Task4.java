...
class Task4 {
    ...
    public static String toCamelCase(String str) {
        return Pattern.compile("_([a-z])").matcher(str)
    ...
    public static void main(String[] args) {
        ...
        assert overTime(new double[] {9, 17, 30, 1.5}).equals("$240.00");
        assert overTime(new double[] {16, 18, 30, 1.8}).equals("$84.00");
        assert overTime(new double[] {13.25, 15, 30, 1.5}).equals("$52.50");
